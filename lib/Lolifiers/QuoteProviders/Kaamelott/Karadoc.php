...
class Karadoc implements QuoteProvider
{
    public function getQuotes()
    {
        return array(
            ...
            "Ce pain-là, il est cuit trop vite dans un four trop chaud ; la montée n'a pas le temps de se faire et il y a trop d'air dans la mie. Donc c'est de la merde.",
